...
export default function GarugaLanding() {
  ...
  return (
    <div style={{ backgroundColor: "#fdfaf7", minHeight: "100vh", color: "#4b3f35", fontFamily: 'serif', paddingBottom: "100px" }}>
      ...
      // 1. Agregá este nuevo estado arriba de todo en tu componente GarugaLanding:
const [datosEnvio, setDatosEnvio] = useState({ cp: "", localidad: "", direccion: "" });

// 2. Modificá tu función finalizarCompraWhatsApp para que incluya los datos:
const finalizarCompraWhatsApp = () => {
...
// 3. En la sección del Checkout dentro del carrito (al final del código), pegá esto:
{carrito.length > 0 && (
